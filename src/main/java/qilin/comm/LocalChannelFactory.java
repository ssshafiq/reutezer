...
public class LocalChannelFactory {
	...
	public class LocalChannel implements Channel {
		...
		/**
		 * A {@link SendableOutputStream} wrapping this qilin.comm.Channel's {@link LocalOutputStream}.
		 */
		SendableOutputStream dataOut;

		/**
		 * A {@link SendableInputStream} wrapping this qilin.comm.Channel's {@link LocalInputStream}.
		 */
		SendableInputStream dataIn;
		

		/**
		 * Last thread to read from this qilin.comm.Channel.
		...
		/**
		 * Last thread to write to this qilin.comm.Channel.
